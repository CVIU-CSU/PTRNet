...
import argparse
import random
from models.ablation_modality_models import union_model, image_model, tabular_model
...
def get_arguments():
    ...
    parser.add_argument("--saveName", type=str, default='no_strategy')
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, data in enumerate(tbar):
            ...
            if args.model_mode == 'union':
                ...
                loss = criterion(outputs, labels) + loss_extra
