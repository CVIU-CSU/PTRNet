...
import argparse
import random
from models.ablation_reembed_models import build_model
...
def get_arguments():
    ...
    parser.add_argument("--vfm",type=str,default='biomedclip',choices=['biomedclip','clip','vit'])
    parser.add_argument("--tab",type=str,default='tabtransformer',choices=['tabtransformer','fttransformer'])
    parser.add_argument("--reembed",type=int,default=1)
...
if __name__ == '__main__':
    ...
    if args.vfm == 'biomedclip':
        ct_data_path = '/home/zhangyinan/2024_05/processed_ct_image_no_resize_v2/feats'
    elif args.vfm == 'vit':
        ct_data_path = '/home/zhangyinan/2024_05/vit_base_imagenet_features/feats'
    elif args.vfm == 'clip':
        ct_data_path = '/home/zhangyinan/2024_05/clip_features/feats'
