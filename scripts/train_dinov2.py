...
import argparse
import random
from models.ablation_reembed_models_dinov2 import build_model
...
def get_arguments():
    ...
    parser.add_argument("--saveName", type=str, default='dinov2')
    ...
    parser.add_argument("--vfm",type=str,default='dinov2',choices=['dinov2'])
...
if __name__ == '__main__':
    ...
    if args.vfm == 'dinov2':
        ct_data_path = '/home/zhangyinan/2024_05/dinov2_features/feats'
